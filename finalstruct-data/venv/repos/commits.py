...
# 根据文件内容创建表头
sql_1 = "CREATE TABLE commits (total VARCHAR(100),week VARCHAR(100),days_1 VARCHAR(100),days_2 VARCHAR(100),days_3 VARCHAR(100),days_4 VARCHAR(100),days_5 VARCHAR(100),days_6 VARCHAR(100),days_7 VARCHAR(100));"
#cur.execute(sql_1) #执行上述sql命令，首次运行时，需要执行上面的语句，用于创建table

headers={'user-agent':'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.108 Safari/537.36'}
url = 'https://api.github.com/repos/elastic/elasticsearch/commits'
